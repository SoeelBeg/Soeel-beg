      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <p className="text-lg text-gray-700 dark:text-gray-300 leading-relaxed">
              I'm a recent graduate with a strong foundation in modern web technologies, and I bring energy, curiosity, and a hunger to learn and grow in every project I take on.

              I love writing clean code, designing beautiful interfaces, and solving real-world problems through technology. Whether it’s frontend development or experimenting with backend tools, I’m always exploring ways to improve and create better digital experiences.
            </p>

            <p className="text-lg text-gray-700 dark:text-gray-300 leading-relaxed">
              When I’m not coding, you’ll find me diving into design trends, exploring open-source contributions, or enjoying a good cup of coffee.
            </p>
